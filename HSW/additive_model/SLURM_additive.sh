...
python /home/hsw967/Programming/RatInABox/HSW/additive_model/main2.py --balance_values 1 --balance_dist additive --responsive_values 0,.2,.4,.6,.8,1 --responsive_type fixed --percent_place_cells .2,.4,.6,.8,1 --num_iters 5 --optional_param work --filename ${input_args[$SLURM_ARRAY_TASK_ID]}
